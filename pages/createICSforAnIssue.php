<?php
    ...
    // Issue to be turned into an ics
    $bug_id    = 11435;
    $bug       = bug_get($bug_id,false);
    $summary   = $bug->summary;
    $datestart = $bug->due_date+3600;
    $dateend   = $bug->due_date+7200;
    $address   = "Eurocontrol HQ - Brussels";
